...
import { Column, Expanded, Row } from "@/lib/widgets/flex";
import { Container } from "@/lib/widgets/container";
import { Image } from "@/lib/widgets/image";
import { Align } from "@/lib/widgets/align";
import { Text } from "@/lib/widgets/paragraph";
import { GestureDetector } from "@/lib/widgets/gesture-detector";
import { Transform } from "@/lib/widgets/transform";
import { Positioned, Stack } from "@/lib/widgets/stack";
import { Padding } from "@/lib/widgets/padding";
import { SizedBox } from "@/lib/widgets/sized-box";
  ...
  build(context: BuildContext): Widget {
    return new Column({
      ...
      children: [
        new Container({
          child: new Row({
            children: [new Text(`虚拟列表滚动滚动${this.itemCount}条`)],
          }),
